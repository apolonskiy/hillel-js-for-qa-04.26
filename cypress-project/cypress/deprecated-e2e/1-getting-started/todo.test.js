...
describe("example to-do app", { testIsolation: true }, () => {
  ...
  it("displays two todo items by default", () => {
    ...
    cy.env(["TEST_VAR_1"]).then(({ TEST_VAR_1 }) => console.log(TEST_VAR_1));
    console.log(Cypress.expose("TEST_VAR_2"));
  ...
  it("can add new todo items", () => {
    ...
    cy.get(".todo-list li").contains(newItem).should("have.text", newItem);
  });
